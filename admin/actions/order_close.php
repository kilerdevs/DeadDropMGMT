...
// Handler for the order_close dispatch route. Runs INSIDE the dispatcher
// envelope (security headers, session, admin auth, POST, CSRF, order
// ownership) — direct requests are refused.
if (!defined('DDMGMT_DISPATCH') || DDMGMT_DISPATCH !== 'order_close') {
...
if ($res !== null) {
    audit('order_close', $id, $res['token']);
